...
## What is OAuth
OAuthは、権限の認可を行うためのオープンスタンダードである。例えばWebアプリケーションにTwitterのパスワードを渡さなくても、認可サーバーから発行されたアクセストークンを用いることでツイートやタイムラインの読み込みを行うことができる。

<img src=https://user-images.githubusercontent.com/34241526/82755818-0f818300-9e11-11ea-98a2-7ca90361d0c1.png width=100% alt="">
...
3. ローカルで動かすので`http://0.0.0.0:8080/result` をTwitterDeveloperのCallback URLに入れる
...
<img src=https://raw.githubusercontent.com/wiki/miya/learning_twitter_oauth/images/demo2.gif width=100% alt="">
